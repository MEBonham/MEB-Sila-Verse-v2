...
interface ReactN extends TypeOfReact {
    ...
    addReducers<G extends {} = State, R extends {} = Reducers>(reducers: AdditionalReducers<G, R>): BooleanFunction;
    ...
    useDispatch<G extends {} = State, R extends {} = Reducers>(): Dispatchers<G, R>;
